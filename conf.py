...
project = u'Programaê! - Aprenda Python' # e.g. How To Think Like a Computer Scientist
copyright = u'Fundação Lemann' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': u"Programaê",

    # Tab name for entire site. (Default: "Site")
    'navbar_site_name': u"Capítulos",
...
html_title = u'Programaê'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'Programaê'
